...
import { CreditListComponent } from './pages/credits-list/credits-list.component';

const routes: Routes = [
  { path: '', component: CreditFormComponent, loadChildren: () => import('./pages/credit-form/credit-form.module').then(m => m.CreditFormModule) },
  { path: 'credits-list', component: CreditListComponent, loadChildren: () => import('./pages/credits-list/credits-list.module').then(m => m.CreditsListModule) },
